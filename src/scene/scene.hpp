...
protected:
  ...
  // eCAL publisher
  static const eCAL::CPublisher *publisher_;

  // publish data
  pb::FusionData::FusionData fusion_data_;

  float pos_x , pos_y , pos_z , rot_x , rot_y , rot_z{0};
  float pos_x_t , pos_y_t , pos_z_t , rot_x_t , rot_y_t , rot_z_t{0};
  float pos_x_e , pos_y_e , pos_z_e , rot_x_e , rot_y_e , rot_z_e{0};
